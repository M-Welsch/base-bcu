import subprocess
from test.utils.backup_environment.virtual_hard_drive import (
    VIRTUAL_HARD_DRIVE_IMAGE,
...
def test_virtual_hard_drive_mountable() -> None:
    with VirtualHardDrive() as virtual_hard_drive:
        ...
        assert (
            VIRTUAL_HARD_DRIVE_MOUNTPOINT.as_posix() in subprocess.check_output("mount").decode()
        ), "please check /etc/fstab"
